...
impl<T> !AnsNotDisplay for Option<T> {}
...
mod tests {
    ...
    #[test]
    fn day3_1() {
        assert_eq_ansval!(7795, days::day3::day3_1("day3"));
    }
    #[test]
    fn day3_2() {
    ...
    #[test]
    fn day8_1() {
        assert_eq_ansval!(1662, days::day8::day8_1("day8"));
    }
    #[test]
    fn day8_2() {
        assert_eq_ansval!(537600, days::day8::day8_2("day8"));
    }
    #[test]
    #[ignore]
    fn day9_1() {
