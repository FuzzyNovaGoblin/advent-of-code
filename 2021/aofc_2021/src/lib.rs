...
mod tests{
    use super::days;
    #[test]fn day1_1(){assert_eq_ansval!(1602, days::day1::day1_1("day1") );}
    #[test]fn day1_2(){assert_eq_ansval!(1633, days::day1::day1_2("day1") );}
    #[test]fn day2_1(){assert_eq_ansval!(2091984, days::day2::day2_1("day2") );}
    #[test]fn day2_2(){assert_eq_ansval!(2086261056, days::day2::day2_2("day2") );}
    #[test]fn day3_1(){assert_eq_ansval!(3882564, days::day3::day3_1("day3") );}
    #[test]fn day3_2(){assert_eq_ansval!(3385170, days::day3::day3_2("day3") );}
    #[test]fn day4_1(){assert_eq_ansval!(39984, days::day4::day4_1("day4") );}
    #[test]fn day4_2(){assert_eq_ansval!(8468, days::day4::day4_2("day4") );}
    #[test]fn day5_1(){assert_eq_ansval!(6856, days::day5::day5_1("day5") );}
    #[test]fn day5_2(){assert_eq_ansval!(20666, days::day5::day5_2("day5") );}
    #[test]fn day6_1(){assert_eq_ansval!(343441, days::day6::day6_1("day6") );}
    #[test]fn day6_2(){assert_eq_ansval!(1569108373832_usize, days::day6::day6_2("day6") );}
    #[test]fn day7_1(){assert_eq_ansval!(328262, days::day7::day7_1("day7") );}
    #[test]fn day7_2(){assert_eq_ansval!(90040997, days::day7::day7_2("day7") );}
    #[test]fn day8_1(){assert_eq_ansval!(390, days::day8::day8_1("day8") );}
    #[test]fn day8_2(){assert_eq_ansval!(1011785, days::day8::day8_2("day8") );}
    #[test]fn day9_1(){assert_eq_ansval!(564, days::day9::day9_1("day9") );}
    #[test]fn day9_2(){assert_eq_ansval!(1038240, days::day9::day9_2("day9") );}
    #[test]fn day10_1(){assert_eq_ansval!(339411, days::day10::day10_1("day10") );}
    #[test]fn day10_2(){assert_eq_ansval!(2289754624_usize, days::day10::day10_2("day10") );}
    #[test]fn day11_1(){assert_eq_ansval!(1741, days::day11::day11_1("day11") );}
    #[test]fn day11_2(){assert_eq_ansval!(440, days::day11::day11_2("day11") );}
    #[test]fn day12_1(){assert_eq_ansval!(4304, days::day12::day12_1("day12") );}
    #[test]fn day12_2(){assert_eq_ansval!(118242, days::day12::day12_2("day12") );}
    #[test]fn day13_1(){assert_eq_ansval!(607, days::day13::day13_1("day13") );}
    #[test]fn day13_2(){assert_eq_ansval!(".##..###..####.#....###..####.####.#....\n#..#.#..#....#.#....#..#.#.......#.#....\n#....#..#...#..#....#..#.###....#..#....\n#....###...#...#....###..#.....#...#....\n#..#.#....#....#....#....#....#....#....\n.##..#....####.####.#....#....####.####.\n", days::day13::day13_2("day13") );}
    #[test]fn day14_1(){assert_eq_ansval!(3259, days::day14::day14_1("day14") );}
    #[test]fn day14_2(){assert_eq_ansval!(3459174981021_usize, days::day14::day14_2("day14") );}
    #[test]fn day15_1(){assert_eq_ansval!(748, days::day15::day15_1("day15") );}
